...
<form:form autocomplete="on" action="#" method="post"
    ...
    <form:input type="text" path="email" id="emailId" placeholder="Email"/>
    <form:errors path="email"/>

    <label for="phoneId">Phone: </label>
    <form:input type="text" path="phone" id="phoneId" placeholder="Phone"/>
    <form:errors path="phone"/>

    <label for="streetId">Street: </label>
    <form:input type="text" path="street" id="streetId" placeholder="Street"/>
    ...
    <form:input type="text" path="town" id="townId" placeholder="Town"/>
